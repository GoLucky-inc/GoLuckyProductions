...
import { Rye, Crimson_Text } from "next/font/google";
...
export const metadata: Metadata = {
  title: "GoLucky Production",
  description: "Innovative apps and games.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${rye.variable} ${crimsonText.variable}`}>
        <nav className="container flex justify-between items-center pt-12 pb-8 animate-fade-in">
          <Link href="/" className="text-2xl hover:text-amber-400 transition-colors" style={{ fontFamily: 'var(--font-display)' }}>
            GoLucky
          </Link>
          <div className="flex items-center gap-8">
            <div className="hidden md:flex gap-6 text-base font-medium text-stone-400">
